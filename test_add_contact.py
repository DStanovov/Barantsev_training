...
class TestAddContact(unittest.TestCase):
    ...
    def test_add_contact(self):
        ...
        self.fill_contact_firms(wd, Contact(firstname="asdasd", middlename="asdasd", lastname="asdasd", nickname="asdasdas", title="asdasda", company="asdasdasd", address="asdasdasd",
    ...
    def fill_contact_firms(self, wd, Contact):
        ...
        wd.find_element_by_name("address2").send_keys(Contact.extra_address)
